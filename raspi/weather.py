...
while(1):
    ...
    print("Wilgotnosc powietrza: " + str(hum))
    cur.execute("INSERT INTO HumidityTable (humidity) VALUES (%f)" % hum)


    (chip_id, chip_version) = readBME280ID()
    temperature, pressure, humidity = readBME280All()
    print("Cisnienie: " + str(pressure) + "hPa")
    cur.execute("INSERT INTO PressureTable (pressure) VALUES (%f)" % pressure)

    ds18b20Sensor = W1ThermSensor()
    tempExt = round(ds18b20Sensor.get_temperature(), 1)
    print('Temperatura: ' + str(tempExt) + 'C')
